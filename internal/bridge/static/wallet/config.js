...
(function () {
  ...
  if (!window.ONEX_BRIDGE_URL) {
    ...
    } else if (location.pathname.startsWith('/wallet') || h === 'zblockchainsystem.com' || h === 'www.zblockchainsystem.com' || h === 'novatrustee.digital' || h.includes('zblockchainsystem') || h.includes('onexproduction')) {
