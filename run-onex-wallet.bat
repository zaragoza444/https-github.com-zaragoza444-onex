POST /bridge/ledger/import
{"balances":{"BTC":"0.5","USD":"1000"},"active":true}
{"balances":{"BTC":"0.5","USD":"1000","EUR":"500"}}
...
set ONEX_LEDGER_MODE=production

set ONEX_BANK_LEDGER_FILE=configs\bank-ledger.example.json
