...
func (c Config) Status() map[string]interface{} {
	...
	return map[string]interface{}{
		...
		"sources": []string{"bank", "m0", "m1", "m2", "m3", "m4", "nsb", "onex", "evm", "portfolio", "import", "bridge7"},
		"fundClasses": []string{FundM0, FundM1, FundM2, FundM3, FundM4, FundMINT, FundNSB},
		"fundClassLabels": map[string]string{
			FundM0:   "M0 — base money / reserves",
			FundM1:   "M1 — spendable wallet / demand deposits",
			FundM2:   "M2 — safeguarded settlement / near money",
			FundM3:   "M3 — treasury liquidity / institutional",
			FundM4:   "M4 — wholesale / tokenized fiat / money market",
			FundMINT: "MINT — stablecoin mint tier",
